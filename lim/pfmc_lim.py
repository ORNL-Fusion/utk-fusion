...
class LimPlots:
    ...
    def lams_overlay(self, absfac = 1.0, time = 4.0, shift = 0):
        ...
        ax.fill_between(lams_itfx, lams_itfnorm-lams_itfnormerror, lams_itfnorm+lams_itfnormerror,  
            facecolor = tableau20[6], alpha = 0.7, label = "LAMS ITF")
        ...
        ax.fill_between(lams_otfx, lams_otfnorm-lams_otfnormerror, lams_otfnorm+lams_otfnormerror,  
            facecolor = tableau20[8], alpha = 0.7, label = "LAMS OTF")
        ax.set_xlabel("Distance along probe [cm]")
        ax.set_ylabel("Normalized W Deposition")
...
#ncpath = '/mnt/c/Users/jmateja/Documents/SASVWlim/lim190422/190422_3000_MCP_v65.nc'
#lp = LimPlots(ncpath)
#lp.lams_overlay()