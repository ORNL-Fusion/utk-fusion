...
sheet = wb.get_sheet_by_name(worksheets[2])
...
ax=sns.heatmap(pivotted,cmap=cm.jet,cbar_kws={'label': 'EF182 '},vmin=0.265,vmax=0.93) #vmax=###### for cbar limit 'Total W Intensity' ",vmin=0.265,vmax=0.93"
# EF180: ',vmin=0,vmax=0.0012' ; EF182: ',vmin=0.265,vmax=0.93' ; EF183: ',vmin=0.0284,vmax=0.1431' ; EF184: ',vmin=0.0279,vmax=0.3064' ; EF186: ',vmin=0.0140,vmax=0.2843'
ax.invert_yaxis()
ax.set(xlim=(0, 201))
