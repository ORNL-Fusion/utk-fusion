...
os.chdir(r'C:\Users\jduran2\Dropbox (ORNL)\UTK\SCGSR\LAMS Data\Sigrafine_Holder') # pick the working directory
...
data_max = int(data_min)+400 #some user input for max data  range or calculate  based on min data  range assuming same scan rate
