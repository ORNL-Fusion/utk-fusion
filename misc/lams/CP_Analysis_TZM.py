...
os.chdir(r'C:\Users\jduran2\Dropbox (ORNL)\UTK\SCGSR\LAMS Data\Raw Export') # pick the working directory
...
LAMS_12 = putIntoArray(sheet, "B"+ data_min, "B" + str(data_max))
LAMS_13 = putIntoArray(sheet, "C"+ data_min, "C" + str(data_max))
LAMS_95 = putIntoArray(sheet, "D"+ data_min, "D" + str(data_max))
LAMS_180 = putIntoArray(sheet, "E"+ data_min, "E" + str(data_max))
LAMS_182 = putIntoArray(sheet, "F"+ data_min, "F" + str(data_max))
LAMS_183 = putIntoArray(sheet, "G"+ data_min, "G" + str(data_max))
LAMS_184 = putIntoArray(sheet, "H"+ data_min, "H" + str(data_max))
LAMS_186 = putIntoArray(sheet, "I"+ data_min, "I" + str(data_max))
bkg_12 = putIntoArray(sheet, "B"+ bkg_min, "B" + bkg_max)
bkg_13 = putIntoArray(sheet, "C"+ bkg_min, "C" + bkg_max)
bkg_95 = putIntoArray(sheet, "D"+ bkg_min, "D" + bkg_max)
bkg_180 = putIntoArray(sheet, "E"+ bkg_min, "E" + bkg_max)
bkg_182 = putIntoArray(sheet, "F"+ bkg_min, "F" + bkg_max)
bkg_183 = putIntoArray(sheet, "G"+ bkg_min, "G" + bkg_max)
bkg_184 = putIntoArray(sheet, "H"+ bkg_min, "H" + bkg_max)
bkg_186 = putIntoArray(sheet, "I"+ bkg_min, "I" + bkg_max)
...
for row in range(0, len(ScanTime)): #start from 0
        ScanDist.append(ScanTime[row]*0.5) #Scan speed of .5 for 500um per second
        
#create average background value in gas blank
avg_bkg_sub_12 = np.mean(bkg_12)
avg_bkg_sub_13 = np.mean(bkg_13)
avg_bkg_sub_95 = np.mean(bkg_95)
...
for row in range(0, len(ScanTime)): #start from 0
        bkg_sub_12.append(LAMS_12[row]-avg_bkg_sub_12)
        bkg_sub_13.append(LAMS_13[row]-avg_bkg_sub_13)
        bkg_sub_95.append(LAMS_95[row]-avg_bkg_sub_95)
...
final_12 = final_W_data(ScanTime, bkg_sub_12)
final_13 = final_W_data(ScanTime, bkg_sub_13)
final_95 = final_W_data(ScanTime, bkg_sub_95)
...
#create total C signal data
total_C = []
for row in range(0, len(ScanTime)): #start from 0
        total_C.append(final_12[row] + final_13[row])
...
for row in range(0, len(ScanTime)): #start from 0
        err12.append(np.sqrt(final_12[row]))
        err13.append(np.sqrt(final_13[row]))
        err95.append(np.sqrt(final_95[row]))
...
W_Dict = {'ScanTime': ScanTime, 'ScanDist': ScanDist, 'C12': final_12, '12err': err12,'C13': final_13, '13err': err13, 'Total C': total_C,'Mo95': final_95, '95err': err95,'W180': final_180, '180err': err180, 
